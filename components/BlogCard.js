...
function BlogCard({name , title , description  , image}) {
    return (
        <div className={name}>
            <div className=" h-72 w-full rounded-t-2xl  " style={{ background: `url(https://newgen-admin.herokuapp.com/public/uploads/images/${image})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>  </div>
