        ...
        <>
                    ...
                    <div className=" mb-52 lg:mb-16 w-10/12 flex mx-auto  justify-around  relative  lg:top-10">
                        ...
                        <div className="flex justify-around w-full ">
                            ...
                            <Fade duration={1000} bottom  >
                                <div className={`  w-32 h-32  lg:w-40 lg:h-40  rounded-3xl ${bg1} shadow-lg grid place-items-center cursor-pointer  group hover:bg-blue-900 transition ease-out duration-500  `} onClick={changeColor1} >
                            ...
                            <Fade duration={1000} bottom delay={600} >
                                <div className={` w-32 h-32  lg:w-40 lg:h-40 ml-5  rounded-3xl ${bg2} shadow-lg grid place-items-center cursor-pointer  group hover:bg-blue-900 transition ease-out duration-500 `} onClick={changeColor2}>
           ...
           <>
                     <div className=" bg-blue-900 mx-auto relative bottom-10 grid place-items-center  " style={{ height: '100px', width: '100px', borderRadius: '50%' }} >
                        ...
                        <div className="flex justify-around w-full text-blue-900">
                    <IoArrowBackCircleOutline onClick={previous}  className=" text-blue-600 hover:text-blue-900 text-5xl mb-5 ml-5 cursor-pointer " />
                    <h3 className=" text-lg lg:text-3xl text-blue-900    font-extrabold w-5/12  mx-auto" > design de  votre  application ?</h3>
                    <IoArrowForwardCircleOutline onClick={moveOn}  className=" text-blue-600 hover:text-blue-900 text-5xl mb-5 mr-5 cursor-pointer " />
                     </div>

                        <div className="  w-10/12 flex mx-auto  justify-around mb-28 relative  top-10">
                            ...
                            <div className="flex justify-around w-full ">
                                ...
                                <Fade duration={1000} bottom  >
                                    <div className={` w-40 h-40 rounded-3xl ${bg1} shadow-lg grid place-items-center cursor-pointer  group hover:bg-blue-900 transition ease-out duration-500 `} onClick={changeColor1} >
                                ...
                                <Fade duration={1000} bottom delay={600} >
                                    <div className={` w-40 h-40  rounded-3xl ${bg3} shadow-lg grid place-items-center cursor-pointer  group hover:bg-blue-900 transition ease-out duration-500 `} onClick={changeColor3}>
