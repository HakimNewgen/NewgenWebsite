...

            {
                service == "web" ? (
                    ...
                    <h3 className="font-bold text-white text-4xl mr-1 " >4/7</h3>
                            ...
                            <div className="flex justify-around w-full text-blue-900">
                        <IoArrowBackCircleOutline onClick={previous}  className=" text-blue-600 hover:text-blue-900 text-5xl mb-5 ml-5 cursor-pointer " />
                        <h3 className="md:text-3xl text-blue-900     font-extrabold w-7/12 relative lg:bottom-24 mx-auto" > Votre système de login ?</h3>
                        ...
                        <IoArrowForwardCircleOutline onClick={movOn}  className=" text-blue-600 hover:text-blue-900 text-5xl mb-5 mr-5 cursor-pointer " />
                            ...
                            <div className="  w-10/12 flex mx-auto  bottom-10 justify-around mb-20  ">
                                ...
                                <div className="flex justify-around w-full  ">
                                    ...
                                    <Fade duration={1000} bottom  >
                                        <div className={` w-40 h-40  mr-5 rounded-3xl ${bg1} shadow-lg grid place-items-center cursor-pointer  group hover:bg-blue-900 transition ease-out duration-500 `} onClick={changeColor1} >
                                    ...
                                    <Fade duration={1000} bottom delay={600} >
                                        <div className={` w-40 h-40 mr-5  rounded-3xl ${bg2} shadow-lg grid place-items-center cursor-pointer  group hover:bg-blue-900 transition ease-out duration-500 `} onClick={changeColor2}>
